...
const departmentSeals: DepartmentSeal[] = [
  ...
  // Replaced SAM with an additional department seal
  {
    src: "/army.avif",
    alt: "Department of the Army Seal",
    title: "U.S. Department of the Army",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
            Trusted by federal agencies to deliver exceptional service and
            support.
          </p>
        </div>
        ...
        >
          {departmentSeals.map((seal, index) => (
            <motion.div
              ...
              whileHover={
                isReducedMotion ? {} : { y: -4, transition: { duration: 0.2 } }
              }
